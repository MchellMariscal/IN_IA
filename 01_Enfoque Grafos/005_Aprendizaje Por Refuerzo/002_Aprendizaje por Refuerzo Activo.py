...
for _ in range(episodios):  # Para cada episodio
    ...
    while estado != (0, 3):  # El objetivo es (0, 3)
        accion = seleccionar_accion(estado)  # Seleccionamos una acción
...
# Ejemplo de aplicación real: En la robótica, el aprendizaje por refuerzo activo puede ser utilizado para entrenar robots a navegar en entornos desconocidos, aprendiendo de las recompensas y penalizaciones para mejorar su comportamiento.
